...
export default function DataTableRowDeleteButton({ handleDelete, rowId }: DataTableRowDeleteButtonProps) {
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>This action cannot be undone. This will permanently delete the field {rowId}.</AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
